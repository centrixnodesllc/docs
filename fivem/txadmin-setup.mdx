---
title: "Set up txAdmin for FiveM on CentrixNodes Game Panel"
description: "Step-by-step guide to install and configure txAdmin for your FiveM server on the CentrixNodes game panel, including recipe setup and admin access."
icon: "house"
---
...
<Note>
  Make sure to note down the PIN code - you'll need it in the next step to set up your master account.
</Note>
