...
alt="Putty login"
/>
Put in the username you got in your email when you bought your VPS. (Most times it's root)
...
Make your FiveM directory and go into it.
...
90% of the time tmux is installed, but in case it's not, run the following commands
