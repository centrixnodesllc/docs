---
title: "Install MariaDB on a Linux VPS server"
description: "Install and configure MariaDB on a Linux VPS: add the repository, secure the database, and enable remote connections for game and web servers."
icon: "database"
---
