---
title: "Add User"
description: "How to setup Remote Desktop for additional users on Windows VPS, or Dedicated Server (with Windows Server OS)"
icon: "users"
---
...
<Note>
  Use a strong password that meets Windows security requirements. We recommend a combination of uppercase letters, lowercase letters, numbers, and special characters.
</Note>
...
<Check>
  **Congratulations!** You've successfully created a new user account. You can now try logging in via Remote Desktop using the new credentials.
</Check>
