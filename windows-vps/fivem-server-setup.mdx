...
Right-click on your desktop, select **New** > **New Folder**, name it, and then open it.
...
Open the folder you created in Step 3, find the `FxServer.exe` file, and double-click it to start your server.

After you start the server, it opens a browser window with the txAdmin panel. Enter the code and proceed to Step 5.
